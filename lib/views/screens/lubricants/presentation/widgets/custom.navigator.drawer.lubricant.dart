...
import 'package:hand_held_shell/config/menus/lubricants.menu.dart';

class CustomNavigationDrawerLubricant extends StatelessWidget {
  final int selectedIndex;
  final Function(int) onDestinationSelected;
  final GlobalKey<ScaffoldState> scaffoldKey;
  final bool hasNotch;

  const CustomNavigationDrawerLubricant({
    super.key,
  ...
  Widget build(BuildContext context) {
    return NavigationDrawer(
      ...
      onDestinationSelected: (value) {
        ...
        final menuItem = appSettingMenuItems[value];
        ...
        try {
          if (menuItem.link.startsWith(RoutesPaths.lubricantsHome)) {
      ...
      children: [
        ...
        ...appSettingMenuItems.map((item) => NavigationDrawerDestination(
              icon: Icon(item.icon),
