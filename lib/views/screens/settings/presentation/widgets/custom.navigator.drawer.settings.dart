...
import 'package:hand_held_shell/config/menus/settings.menu.dart';

class CustomNavigationDrawerSetting extends StatelessWidget {
  final int selectedIndex;
  final Function(int) onDestinationSelected;
  final GlobalKey<ScaffoldState> scaffoldKey;
  final bool hasNotch;

  const CustomNavigationDrawerSetting({
    super.key,
  ...
  Widget build(BuildContext context) {
    return NavigationDrawer(
      ...
      onDestinationSelected: (value) {
        ...
        try {
          if (menuItem.link.startsWith(RoutesPaths.settingsHome)) {
